...
console.log('------ variables ----------');
    ...
    //var name = "Alexander"/*, course = "Programming for Web Applications 1", month = 8 */;
    //var course = "Programming for Web Applications 1";
    //var month = 8;
    //console.log("Name: " + name + "\nCourse: " + course + "\nMonth: " + month);

    //example 2: variables not defined will = "undefined"
    //var name, course, month; // Defining variables without assigning values to them
    //console.log("Name: " + name + "\nCourse: " + course + "\nMonth: " + month);
    
    //example 3: a mix of variables defined and not defined
    //var name, course = "Programming for Web Applications 1", month; // Defining variables without assigning values to them
    //console.log("Name: " + name + "\nCourse: " + course + "\nMonth: " + month);
...
console.log('------ strings ----------');
    ...
    //basic string
    //var name = "James Bond";
    //var testString = "He's in Programming for Web Applications 1";
    //console.log(name);
    //console.log("Example 1: " + testString);

    //string w/ escape characters " \ "
    //var testString2 = "I'll need some \"escape characters\" here!";
    //console.log(testString2);
    
    //string w/ escape characters and mixed single/double quotes
    //var testString3 = "Look! Over there. It's a string with a mix of double quotes and \"single quotes\"!";
    //console.log(testString3);

    //this example shows that all the "phase" vars above were overwritten
    //var section = 3;
    //var testString4 = 'He\'s in PAW-' + section;
